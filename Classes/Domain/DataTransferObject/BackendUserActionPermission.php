...
final class BackendUserActionPermission extends AbstractPermission
{
    ...
    public const ACTION_ADD_SYS_FILEMOUNTS = 6;
    public const ACTION_DELETE_SYS_FILEMOUNTS = 7;
    ...
    public static function getItems(): array
    {
        return [
            ...
            self::ACTION_ADD_SYS_FILEMOUNTS => [
                'LLL:EXT:my_user_management/Resources/Private/Language/locallang_be.xlf:backend_access_action_permissions.action_add_sys_filemounts.title',
                'my_user_management-permissions-actions-add',
            ],
            self::ACTION_DELETE_SYS_FILEMOUNTS => [
                'LLL:EXT:my_user_management/Resources/Private/Language/locallang_be.xlf:backend_access_action_permissions.action_delete_sys_filemounts.title',
                'my_user_management-permissions-actions-delete',
            ],
        ];
    }
     ...
     * @return bool
     */
    public static function sysFilemountsCreationAllowed(): bool
    {
        return static::isConfigured(self::ACTION_ADD_SYS_FILEMOUNTS);
    }

    /**
     * @return bool
     */
    public static function sysFilemountsDeletionAllowed(): bool
    {
        return static::isConfigured(self::ACTION_DELETE_SYS_FILEMOUNTS);
    }
}
