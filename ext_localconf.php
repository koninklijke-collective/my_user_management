...
call_user_func(function ($extension): void {
    ...
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['checkModifyAccessList'][$extension] = \KoninklijkeCollective\MyUserManagement\Hook\DataHandlerCheckModifyAccessListHook::class;
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['Backend\Template\Components\ButtonBar']['getButtonsHook'][$extension] = \KoninklijkeCollective\MyUserManagement\Hook\ButtonBarHook::class . '->getButtons';
}, 'my_user_management');
